...
public class ModItems {
    //GUI Elements
    public static final Item GUI_BG = registerItem("gui_bg", new Item(new Item.Settings()));
    public static final Item GUI_CONFIRM = registerItem("gui_confirm", new Item(new Item.Settings()));
    public static final Item GUI_CONFIRM_BG = registerItem("gui_confirm_bg", new Item(new Item.Settings()));
    public static final Item GUI_DENY = registerItem("gui_deny", new Item(new Item.Settings()));
    public static final Item GUI_DENY_BG = registerItem("gui_deny_bg", new Item(new Item.Settings()));
    public static final Item GUI_DOWN_BG_DARK = registerItem("gui_down_bg_dark", new Item(new Item.Settings()));
    public static final Item GUI_DOWN_BG_LIGHT = registerItem("gui_down_bg_light", new Item(new Item.Settings()));
    public static final Item GUI_DOWN_BG_YELLOW = registerItem("gui_down_bg_yellow", new Item(new Item.Settings()));
    public static final Item GUI_DOWN_DARK = registerItem("gui_down_dark", new Item(new Item.Settings()));
    public static final Item GUI_DOWN_LIGHT = registerItem("gui_down_light", new Item(new Item.Settings()));
    public static final Item GUI_DOWN_YELLOW = registerItem("gui_down_yellow", new Item(new Item.Settings()));
    public static final Item GUI_HELP = registerItem("gui_help", new Item(new Item.Settings()));
    public static final Item GUI_HELP_BG = registerItem("gui_help_bg", new Item(new Item.Settings()));
    public static final Item GUI_HELP_BG_COLOR = registerItem("gui_help_bg_color", new Item(new Item.Settings()));
    public static final Item GUI_HELP_COLOR = registerItem("gui_help_color", new Item(new Item.Settings()));
    public static final Item GUI_HOME = registerItem("gui_home", new Item(new Item.Settings()));
    public static final Item GUI_HOME_BG = registerItem("gui_home_bg", new Item(new Item.Settings()));
    public static final Item GUI_INFO = registerItem("gui_info", new Item(new Item.Settings()));
    public static final Item GUI_INFO_BG = registerItem("gui_info_bg", new Item(new Item.Settings()));
    public static final Item GUI_LEFT_BG_DARK = registerItem("gui_left_bg_dark", new Item(new Item.Settings()));
    public static final Item GUI_LEFT_BG_LIGHT = registerItem("gui_left_bg_light", new Item(new Item.Settings()));
    public static final Item GUI_LEFT_BG_YELLOW = registerItem("gui_left_bg_yellow", new Item(new Item.Settings()));
    public static final Item GUI_LEFT_DARK = registerItem("gui_left_dark", new Item(new Item.Settings()));
    public static final Item GUI_LEFT_LIGHT = registerItem("gui_left_light", new Item(new Item.Settings()));
    public static final Item GUI_LEFT_YELLOW = registerItem("gui_left_yellow", new Item(new Item.Settings()));
    public static final Item GUI_LOCK_BG_DARK = registerItem("gui_lock_bg_dark", new Item(new Item.Settings()));
    public static final Item GUI_LOCK_BG_LIGHT = registerItem("gui_lock_bg_light", new Item(new Item.Settings()));
    public static final Item GUI_LOCK_BG_RED = registerItem("gui_lock_bg_red", new Item(new Item.Settings()));
    public static final Item GUI_LOCK_BG_YELLOW = registerItem("gui_lock_bg_yellow", new Item(new Item.Settings()));
    public static final Item GUI_LOCK_DARK = registerItem("gui_lock_dark", new Item(new Item.Settings()));
    public static final Item GUI_LOCK_LIGHT = registerItem("gui_lock_light", new Item(new Item.Settings()));
    public static final Item GUI_LOCK_RED = registerItem("gui_lock_red", new Item(new Item.Settings()));
    public static final Item GUI_LOCK_YELLOW = registerItem("gui_lock_yellow", new Item(new Item.Settings()));
    public static final Item GUI_MENU = registerItem("gui_menu", new Item(new Item.Settings()));
    public static final Item GUI_MENU_BG = registerItem("gui_menu_bg", new Item(new Item.Settings()));
    public static final Item GUI_MINUS = registerItem("gui_minus", new Item(new Item.Settings()));
    public static final Item GUI_MINUS_BG = registerItem("gui_minus_bg", new Item(new Item.Settings()));
    public static final Item GUI_MINUS_BG_COLOR = registerItem("gui_minus_bg_color", new Item(new Item.Settings()));
    public static final Item GUI_MINUS_COLOR = registerItem("gui_minus_color", new Item(new Item.Settings()));
    public static final Item GUI_PALETTE = registerItem("gui_palette", new Item(new Item.Settings()));
    public static final Item GUI_PLUS = registerItem("gui_plus", new Item(new Item.Settings()));
    public static final Item GUI_PLUS_BG = registerItem("gui_plus_bg", new Item(new Item.Settings()));
    public static final Item GUI_PLUS_BG_COLOR = registerItem("gui_plus_bg_color", new Item(new Item.Settings()));
    public static final Item GUI_PLUS_COLOR = registerItem("gui_plus_color", new Item(new Item.Settings()));
    public static final Item GUI_RIGHT_BG_DARK = registerItem("gui_right_bg_dark", new Item(new Item.Settings()));
    public static final Item GUI_RIGHT_BG_LIGHT = registerItem("gui_right_bg_light", new Item(new Item.Settings()));
    public static final Item GUI_RIGHT_BG_YELLOW = registerItem("gui_right_bg_yellow", new Item(new Item.Settings()));
    public static final Item GUI_RIGHT_DARK = registerItem("gui_right_dark", new Item(new Item.Settings()));
    public static final Item GUI_RIGHT_LIGHT = registerItem("gui_right_light", new Item(new Item.Settings()));
    public static final Item GUI_RIGHT_YELLOW = registerItem("gui_right_yellow", new Item(new Item.Settings()));
    public static final Item GUI_SETTINGS = registerItem("gui_settings", new Item(new Item.Settings()));
    public static final Item GUI_SETTINGS_BG = registerItem("gui_settings_bg", new Item(new Item.Settings()));
    public static final Item GUI_UP_BG_DARK = registerItem("gui_up_bg_dark", new Item(new Item.Settings()));
    public static final Item GUI_UP_BG_LIGHT = registerItem("gui_up_bg_light", new Item(new Item.Settings()));
    public static final Item GUI_UP_BG_YELLOW = registerItem("gui_up_bg_yellow", new Item(new Item.Settings()));
    public static final Item GUI_UP_DARK = registerItem("gui_up_dark", new Item(new Item.Settings()));
    public static final Item GUI_UP_LIGHT = registerItem("gui_up_light", new Item(new Item.Settings()));
    public static final Item GUI_UP_YELLOW = registerItem("gui_up_yellow", new Item(new Item.Settings()));
    public static final Item GUI_USER = registerItem("gui_user", new Item(new Item.Settings()));
    public static final Item GUI_USER_BG = registerItem("gui_user_bg", new Item(new Item.Settings()));
