...
public class ModBlocks {
    ...
    public static final Block MINES_FOSSILISED_SAND = registerBlock("mines_fossilised_sand",
            new Block(AbstractBlock.Settings.create().strength(0.5f).requiresTool().sounds(BlockSoundGroup.SAND)));
    public static final Block MINES_FOSSILISED_STONE = registerBlock("mines_fossilised_stone",
            new Block(AbstractBlock.Settings.create().strength(0.5f).requiresTool().sounds(BlockSoundGroup.STONE)));
    public static final Block MINES_FOSSILISED_DEEPSLATE = registerBlock("mines_fossilised_deepslate",
            new Block(AbstractBlock.Settings.create().strength(0.5f).requiresTool().sounds(BlockSoundGroup.DEEPSLATE)));
