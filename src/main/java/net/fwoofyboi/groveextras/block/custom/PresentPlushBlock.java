...
public class PresentPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<PresentPlushBlock> CODEC = createCodec(PresentPlushBlock::new);
    ...
    public PresentPlushBlock(Settings settings) {
        super(settings);
    }
