...
public class RoggenrolaPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<RoggenrolaPlushBlock> CODEC = createCodec(RoggenrolaPlushBlock::new);
    ...
    public RoggenrolaPlushBlock(Settings settings) {
        super(settings);
    }
