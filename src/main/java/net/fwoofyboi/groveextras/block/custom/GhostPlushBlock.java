...
public class GhostPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<GhostPlushBlock> CODEC = createCodec(GhostPlushBlock::new);
    ...
    public GhostPlushBlock(Settings settings) {
        super(settings);
    }
