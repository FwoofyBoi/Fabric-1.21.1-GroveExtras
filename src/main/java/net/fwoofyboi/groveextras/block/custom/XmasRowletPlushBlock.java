...
public class XmasRowletPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<XmasRowletPlushBlock> CODEC = createCodec(XmasRowletPlushBlock::new);
    ...
    public XmasRowletPlushBlock(Settings settings) {
        super(settings);
    }
