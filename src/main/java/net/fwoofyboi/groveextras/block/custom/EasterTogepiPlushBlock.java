...
public class EasterTogepiPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<EasterTogepiPlushBlock> CODEC = createCodec(EasterTogepiPlushBlock::new);
    ...
    public EasterTogepiPlushBlock(Settings settings) {
        super(settings);
    }
