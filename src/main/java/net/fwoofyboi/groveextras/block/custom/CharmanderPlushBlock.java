...
public class CharmanderPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<CharmanderPlushBlock> CODEC = createCodec(CharmanderPlushBlock::new);
    ...
    public CharmanderPlushBlock(Settings settings) {
        super(settings);
    }
