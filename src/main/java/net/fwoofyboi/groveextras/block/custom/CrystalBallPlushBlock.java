...
public class CrystalBallPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<CrystalBallPlushBlock> CODEC = createCodec(CrystalBallPlushBlock::new);
    ...
    public CrystalBallPlushBlock(Settings settings) {
        super(settings);
    }
