...
public class TylersFishBlock extends HorizontalFacingBlock {

    public static final MapCodec<TylersFishBlock> CODEC = createCodec(TylersFishBlock::new);
    ...
    public TylersFishBlock(Settings settings) {
        super(settings);
    }
