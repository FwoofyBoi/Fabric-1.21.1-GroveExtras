...
public class ChickPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<ChickPlushBlock> CODEC = createCodec(ChickPlushBlock::new);
    ...
    public ChickPlushBlock(Settings settings) {
        super(settings);
    }
