...
public class SmolivPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<SmolivPlushBlock> CODEC = createCodec(SmolivPlushBlock::new);
    ...
    public SmolivPlushBlock(Settings settings) {
        super(settings);
    }
