...
public class PumpkinPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<PumpkinPlushBlock> CODEC = createCodec(PumpkinPlushBlock::new);
    ...
    public PumpkinPlushBlock(Settings settings) {
        super(settings);
    }
