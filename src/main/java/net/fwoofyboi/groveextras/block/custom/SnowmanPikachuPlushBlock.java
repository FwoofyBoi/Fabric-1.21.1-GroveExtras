...
public class SnowmanPikachuPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<SnowmanPikachuPlushBlock> CODEC = createCodec(SnowmanPikachuPlushBlock::new);
    ...
    public SnowmanPikachuPlushBlock(Settings settings) {
        super(settings);
    }
