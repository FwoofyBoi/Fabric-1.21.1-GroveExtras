...
public class CastformPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<CastformPlushBlock> CODEC = createCodec(CastformPlushBlock::new);
    ...
    public CastformPlushBlock(Settings settings) {
        super(settings);
    }
