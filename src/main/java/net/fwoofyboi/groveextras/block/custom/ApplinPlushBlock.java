...
public class ApplinPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<ApplinPlushBlock> CODEC = createCodec(ApplinPlushBlock::new);
    ...
    public ApplinPlushBlock(Settings settings) {
        super(settings);
    }
