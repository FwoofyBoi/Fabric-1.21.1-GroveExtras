...
public class XmasTreePlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<XmasTreePlushBlock> CODEC = createCodec(XmasTreePlushBlock::new);
    ...
    public XmasTreePlushBlock(Settings settings) {
        super(settings);
    }
