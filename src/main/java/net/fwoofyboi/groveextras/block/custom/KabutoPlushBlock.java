...
public class KabutoPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<KabutoPlushBlock> CODEC = createCodec(KabutoPlushBlock::new);
    ...
    public KabutoPlushBlock(Settings settings) {
        super(settings);
    }
