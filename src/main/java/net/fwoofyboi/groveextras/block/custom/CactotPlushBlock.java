...
public class CactotPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<CactotPlushBlock> CODEC = createCodec(CactotPlushBlock::new);
    ...
    public CactotPlushBlock(Settings settings) {
        super(settings);
    }
