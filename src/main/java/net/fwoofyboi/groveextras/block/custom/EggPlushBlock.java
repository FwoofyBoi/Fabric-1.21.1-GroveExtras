...
public class EggPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<EggPlushBlock> CODEC = createCodec(EggPlushBlock::new);
    ...
    public EggPlushBlock(Settings settings) {
        super(settings);
    }
