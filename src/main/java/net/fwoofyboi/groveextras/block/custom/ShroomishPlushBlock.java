...
public class ShroomishPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<ShroomishPlushBlock> CODEC = createCodec(ShroomishPlushBlock::new);
    ...
    public ShroomishPlushBlock(Settings settings) {
        super(settings);
    }
