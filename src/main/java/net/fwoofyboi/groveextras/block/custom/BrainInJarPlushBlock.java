...
public class BrainInJarPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<BrainInJarPlushBlock> CODEC = createCodec(BrainInJarPlushBlock::new);
    ...
    public BrainInJarPlushBlock(Settings settings) {
        super(settings);
    }
