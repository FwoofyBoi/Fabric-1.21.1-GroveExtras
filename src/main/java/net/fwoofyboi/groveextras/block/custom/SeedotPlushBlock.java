...
public class SeedotPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<SeedotPlushBlock> CODEC = createCodec(SeedotPlushBlock::new);
    ...
    public SeedotPlushBlock(Settings settings) {
        super(settings);
    }
