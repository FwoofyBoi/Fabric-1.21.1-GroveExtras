...
public class PincurchinPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<PincurchinPlushBlock> CODEC = createCodec(PincurchinPlushBlock::new);
    ...
    public PincurchinPlushBlock(Settings settings) {
        super(settings);
    }
