...
public class SnowmanPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<SnowmanPlushBlock> CODEC = createCodec(SnowmanPlushBlock::new);
    ...
    public SnowmanPlushBlock(Settings settings) {
        super(settings);
    }
