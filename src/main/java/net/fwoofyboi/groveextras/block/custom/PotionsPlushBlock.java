...
public class PotionsPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<PotionsPlushBlock> CODEC = createCodec(PotionsPlushBlock::new);
    ...
    public PotionsPlushBlock(Settings settings) {
        super(settings);
    }
