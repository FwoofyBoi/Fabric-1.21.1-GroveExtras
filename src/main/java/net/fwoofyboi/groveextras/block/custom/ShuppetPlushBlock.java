...
public class ShuppetPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<ShuppetPlushBlock> CODEC = createCodec(ShuppetPlushBlock::new);
    ...
    public ShuppetPlushBlock(Settings settings) {
        super(settings);
    }
