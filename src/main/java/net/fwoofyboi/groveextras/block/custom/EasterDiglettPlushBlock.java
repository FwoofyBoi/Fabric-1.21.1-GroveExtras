...
public class EasterDiglettPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<EasterDiglettPlushBlock> CODEC = createCodec(EasterDiglettPlushBlock::new);
    ...
    public EasterDiglettPlushBlock(Settings settings) {
        super(settings);
    }
