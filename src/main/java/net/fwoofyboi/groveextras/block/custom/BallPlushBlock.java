...
public class BallPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<BallPlushBlock> CODEC = createCodec(BallPlushBlock::new);
    ...
    public BallPlushBlock(Settings settings) {
        super(settings);
    }
