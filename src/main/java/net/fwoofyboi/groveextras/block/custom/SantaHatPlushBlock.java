...
public class SantaHatPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<SantaHatPlushBlock> CODEC = createCodec(SantaHatPlushBlock::new);
    ...
    public SantaHatPlushBlock(Settings settings) {
        super(settings);
    }
