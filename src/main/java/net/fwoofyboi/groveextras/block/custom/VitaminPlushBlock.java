...
public class VitaminPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<VitaminPlushBlock> CODEC = createCodec(VitaminPlushBlock::new);
    ...
    public VitaminPlushBlock(Settings settings) {
        super(settings);
    }
