...
public class PhantumpPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<PhantumpPlushBlock> CODEC = createCodec(PhantumpPlushBlock::new);
    ...
    public PhantumpPlushBlock(Settings settings) {
        super(settings);
    }
