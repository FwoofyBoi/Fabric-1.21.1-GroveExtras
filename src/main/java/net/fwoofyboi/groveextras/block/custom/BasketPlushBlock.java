...
public class BasketPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<BasketPlushBlock> CODEC = createCodec(BasketPlushBlock::new);
    ...
    public BasketPlushBlock(Settings settings) {
        super(settings);
    }
