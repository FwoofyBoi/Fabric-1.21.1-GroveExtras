...
public class PouchPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<PouchPlushBlock> CODEC = createCodec(PouchPlushBlock::new);
    ...
    public PouchPlushBlock(Settings settings) {
        super(settings);
    }
