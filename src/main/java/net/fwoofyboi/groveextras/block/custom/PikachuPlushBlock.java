...
public class PikachuPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<PikachuPlushBlock> CODEC = createCodec(PikachuPlushBlock::new);
    ...
    public PikachuPlushBlock(Settings settings) {
        super(settings);
    }
