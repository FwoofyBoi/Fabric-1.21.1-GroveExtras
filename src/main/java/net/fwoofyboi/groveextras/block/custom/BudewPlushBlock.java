...
public class BudewPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<BudewPlushBlock> CODEC = createCodec(BudewPlushBlock::new);
    ...
    public BudewPlushBlock(Settings settings) {
        super(settings);
    }
