...
public class RowletPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<RowletPlushBlock> CODEC = createCodec(RowletPlushBlock::new);
    ...
    public RowletPlushBlock(Settings settings) {
        super(settings);
    }
