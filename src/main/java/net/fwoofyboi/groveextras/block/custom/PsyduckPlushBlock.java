...
public class PsyduckPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<PsyduckPlushBlock> CODEC = createCodec(PsyduckPlushBlock::new);
    ...
    public PsyduckPlushBlock(Settings settings) {
        super(settings);
    }
