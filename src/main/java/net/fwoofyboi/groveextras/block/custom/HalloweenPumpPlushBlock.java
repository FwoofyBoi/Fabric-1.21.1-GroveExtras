...
public class HalloweenPumpPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<HalloweenPumpPlushBlock> CODEC = createCodec(HalloweenPumpPlushBlock::new);
    ...
    public HalloweenPumpPlushBlock(Settings settings) {
        super(settings);
    }
