...
public class DiglettPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<DiglettPlushBlock> CODEC = createCodec(DiglettPlushBlock::new);
    ...
    public DiglettPlushBlock(Settings settings) {
        super(settings);
    }
