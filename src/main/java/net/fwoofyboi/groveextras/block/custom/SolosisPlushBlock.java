...
public class SolosisPlushBlock extends HorizontalFacingBlock {

    public static final MapCodec<SolosisPlushBlock> CODEC = createCodec(SolosisPlushBlock::new);
    ...
    public SolosisPlushBlock(Settings settings) {
        super(settings);
    }
